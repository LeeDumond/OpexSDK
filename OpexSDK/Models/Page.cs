...
namespace OpexSDK.Models
{
    ...
    public class Page
    {
        ...
        ///     original DocumentLocator is retained.
        /// </summary>
        public int? DocumentLocator { get; internal set; }

        /// <summary>
        ///     Sequence number in batch. Batch tickets have a Sequence Number of zero, The Sequence Number of the first non-batch
        ///     ticket page may be 1 or another larger number as defined in the job file.
        /// </summary>
        ...
        /// <summary>
        ///     Unique identifier corresponding to page scan sequence. Sometimes this equals BatchSequence Number. However, in any
        ///     operation that can cause the image to be reprocessed, such as if a page is deleted, rescanned, rotated, or voided,
        ...
        /// <summary>
        ///     Indicates whether or not this is a simulated item created from loaded front and back images and a simulated
        ///     Magnetic MICR line. If false, the item is a 'normal' item created by scanning an actual piece of paper; otherwise,
        ///     the item was not created by scanning a piece of paper, but is a simulated piece resulting from loaded front and
        ///     back images and a simulated Magnetic MICR line.
        /// </summary>
        ...
        /// <summary>
        ///     Specific identifier assigned to page, specified during job setup and/or by the operator during runtime. This is
        ///     used for sub-classification of PageTypes. Multiple SubPageNames may have the same PageName.
        /// </summary>
        public string SubPageName { get; internal set; }

        /// <summary>
        ///     Indicates whether or not the operator specified the PageType. If true; the PageType was specified by the operator;
        ///     otherwise, the PageType was determined by the system.
        /// </summary>
        ...
        /// <summary>
        ///     Indicator whether piece is an envelope based on thickness profile. If true, envelope was detected; if false,
        ///     envelope was not detected; if null, envelope thickness detection was disabled.
        /// </summary>
        public EnvelopeDetect? EnvelopeDetect { get; internal set; }

        /// <summary>
        ///     Average thickness in "thickness units" where 1 thickness unit equals approximately 0.004 inches. Single pieces of
        ///     "average" thickness should have a reading of about 1.00.
        /// </summary>
        public float? AverageThickness { get; internal set; }

        /// <summary>
        ///     Item skew detected in degrees. Records the skew of the front image. If null, it indicates that skew was not
        ///     calculated. This is meant for diagnostic purposes only and records the skew of the actual item on the track. It
        ///     does not necessarily correspond to the images saved in the batch, as they may or may not have been deskewed.
        /// </summary>
        public float? SkewDegrees { get; internal set; }

        /// <summary>
        ///     Indicates any deskewing that was applied. If true, deskew was enabled and the image was deskewed; if false, deskew
        ///     was enabled but the image was not deskewed; if null, deskew was disabled.
        /// </summary>
        public DeskewStatus? DeskewStatus { get; internal set; }

        /// <summary>
        ///     Indicates the detection of a streak in the front of the scan. If true, a streak was detected; if false, a streak
        ///     was not detected; if null, no streak detection was performed.
        /// </summary>
        public FrontStreakDetectStatus? FrontStreakDetectStatus { get; internal set; }

        /// <summary>
        ///     Indicates the detection of a streak in the back of the scan. If true, a streak was detected; if false, a streak was
        ///     not detected; if null, no streak detection was performed.
        /// </summary>
