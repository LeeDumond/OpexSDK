...
namespace OpexSDK.Tests
{
    public class SchemaValidationTests : IClassFixture<FileSystemFixture>
    {
        ...
        public async Task ReadBatchAsync_InvalidSchema()
        {
            ...
            var reader = new BatchReader(@"C:\Opex\test1.oxi", @"C:\Opex\badSchema.xsd", false, _fileSystemFixture.FileSystem);
        ...
        public async Task ReadBatchAsync_UnexpectedAttributeAndElement()
        {
            ...
            var reader = new BatchReader(@"C:\Opex\test.oxi", @"C:\Opex\schema.xsd", false, _fileSystemFixture.FileSystem);
        ...
        public void ReadBatch_InvalidSchema_ThrowOnError()
        {
            ...
            var reader = new BatchReader(@"C:\Opex\test1.oxi", @"C:\Opex\badSchema.xsd", true, _fileSystemFixture.FileSystem);

            Batch ReadBatch() => reader.ReadBatch();
        ...
        public void ReadBatch_UnexpectedAttributeAndElement_ThrowOnError()
        {
            ...
            var reader = new BatchReader(@"C:\Opex\test.oxi", @"C:\Opex\schema.xsd", true, _fileSystemFixture.FileSystem);
