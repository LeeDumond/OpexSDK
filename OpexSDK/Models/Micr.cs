...
{
    /// <summary>
    ///     Contains information about a single MICR read. NOTE: Different OPEX products can use Magnetic readers, Optical
    ///     readers, or a combination of both, when reading a MICR line. There is no indication as to which type(s) of reader
    ///     was used.
    /// </summary>
    public class Micr
    {
        ...
        /// <summary>
        ///     The final result of the MICR read. Data includes numeric digits plus the following special symbol designators: 'c'
        ///     – on us 'd' – routing/transit 'b' – amount '-' – dash '!' – rejected or unknown character.
        /// </summary>
