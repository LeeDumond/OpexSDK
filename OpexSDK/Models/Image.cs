...
namespace OpexSDK.Models
{
    ...
    public class Image
    {
        ...
        /// <summary>
        ///     The index of the Image, and (on AS36xx, AS7200, DS2200 or Falcon) its corresponding snippet definition in the job
        ///     used to create the batch. Values are 1-indexed. (i.e., "1" is the first index.)
        /// </summary>
        ...
        ///     If true, the area was determined to be blank; if false, the area was determined not to be blank; if null, the image
        ///     was not tested for blank area.
        ...
        /// <summary>
        ///     Image file name combining, as per scanning software job parameters, various pieces of item-wise information, such
        ///     as Scan Sequence number, snippet/image number, audit trail text and possibly an ordinal (#) to prevent
        ///     duplications. The default is [Scan Sequence].ext.
        /// </summary>
        ...
        /// <summary>
        ///     The dimension of the image in pixels in the horizontal direction. If image Type is Snippet, equals the length of
        ///     the snippet rectangle.
        /// </summary>
        public int? Length { get; internal set; }

        /// <summary>
        ///     The dimension of the image in pixels in the vertical direction. If image Type is Snippet, equals the height of the
        ///     snippet rectangle.
        /// </summary>
        public int? Height { get; internal set; }

        /// <summary>
        ///     If Type is Full, this value will be 0. If Type is Snippet, equals the horizontal offset in pixels from the upper
        ///     left corner of the full image to the upper left corner of the snippet.
        /// </summary>
        public int? OffsetLength { get; internal set; }

        /// <summary>
        ///     If Type is Full, this value will be 0. If Type is Snippet, equals the vertical offset in pixels from the upper left
        ///     corner of the full image to the upper left corner of the snippet.
        /// </summary>
