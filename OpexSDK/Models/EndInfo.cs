...
namespace OpexSDK.Models
{
    ...
    public class EndInfo
    {
        ...
        ///     This information is redundant in that it can be derived from the Count of the Pages collection in the Batch. It is
        ...
        ///     This information is redundant in that it can be derived from the Count of the Groups collection in the Batch. It is
        ///     provided primarily as a convenience.
        /// </summary>
        public int? NumGroups { get; internal set; }

        /// <summary>
        ///     The total number of transactions in the batch, EXCLUDING batch tickets.
        ///     This value may differ from the count of the Transactions collection in the Batch. It is provided primarily as a
        ///     convenience.
        /// </summary>
        public int? NumTransactions { get; internal set; }

        /// <summary>
        ///     Indicates whether or not the batch was modified (by the AS3600 Batch Editor, for example) after scanning was
        ///     completed.
